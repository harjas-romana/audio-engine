/* ================================================================
   AUDIO ENGINE v2.1 — Popup Controller
   Enhanced with vocal processing, tube saturation, 
   sub-bass enhancer, multi-band compression, de-esser & more.
   ================================================================ */
(() => {
  'use strict';
  ...
  const FACTORY_PRESETS = {
    flat: {
      ...
      enhance:{masterVol:100,balance:0,compThreshold:-24,compRatio:4,compAttack:3,compRelease:250,clarity:0,warmth:22000,loudnessNorm:false,monoCompat:false,analogWarmth:false,noiseGate:false,tubeSaturation:false,subBassEnhance:false,multiBandComp:false,deEsser:false,vocalEnhance:0,vocalExciter:0,speed:100,pitch:0},
      tone:{subBass:0,presence:0,air:0,bassPunch:0,sparkle:0}
    },
    'bass-heavy': {
      ...
      enhance:{masterVol:105,balance:0,compThreshold:-20,compRatio:5,compAttack:5,compRelease:200,clarity:0,warmth:22000,loudnessNorm:false,monoCompat:false,analogWarmth:true,noiseGate:false,tubeSaturation:true,subBassEnhance:true,multiBandComp:true,deEsser:false,vocalEnhance:0,vocalExciter:0,speed:100,pitch:0},
      tone:{subBass:8,presence:0,air:0,bassPunch:7,sparkle:0}
    },
    bright: {
      ...
      enhance:{masterVol:100,balance:0,compThreshold:-22,compRatio:3,compAttack:3,compRelease:250,clarity:30,warmth:22000,loudnessNorm:false,monoCompat:false,analogWarmth:false,noiseGate:false,tubeSaturation:false,subBassEnhance:false,multiBandComp:false,deEsser:true,vocalEnhance:30,vocalExciter:20,speed:100,pitch:0},
      tone:{subBass:0,presence:3,air:6,bassPunch:0,sparkle:5}
    },
    warm: {
      ...
      enhance:{masterVol:100,balance:0,compThreshold:-22,compRatio:4,compAttack:5,compRelease:300,clarity:0,warmth:14000,loudnessNorm:false,monoCompat:false,analogWarmth:true,noiseGate:false,tubeSaturation:true,subBassEnhance:false,multiBandComp:false,deEsser:false,vocalEnhance:10,vocalExciter:0,speed:100,pitch:0},
      tone:{subBass:3,presence:-2,air:0,bassPunch:2,sparkle:0}
    },
    vocal: {
      ...
      enhance:{masterVol:100,balance:0,compThreshold:-18,compRatio:3,compAttack:2,compRelease:200,clarity:80,warmth:18000,loudnessNorm:false,monoCompat:false,analogWarmth:false,noiseGate:false,tubeSaturation:false,subBassEnhance:false,multiBandComp:false,deEsser:true,vocalEnhance:85,vocalExciter:60,speed:100,pitch:0},
      tone:{subBass:0,presence:4,air:2,bassPunch:0,sparkle:1}
    },
    podcast: {
      ...
      enhance:{masterVol:115,balance:0,compThreshold:-15,compRatio:8,compAttack:1,compRelease:150,clarity:120,warmth:16000,loudnessNorm:true,monoCompat:false,analogWarmth:false,noiseGate:true,tubeSaturation:false,subBassEnhance:false,multiBandComp:true,deEsser:true,vocalEnhance:70,vocalExciter:40,speed:100,pitch:0},
      tone:{subBass:0,presence:5,air:0,bassPunch:0,sparkle:0}
    },
    lofi: {
      ...
      enhance:{masterVol:95,balance:0,compThreshold:-20,compRatio:6,compAttack:10,compRelease:400,clarity:0,warmth:10000,loudnessNorm:false,monoCompat:false,analogWarmth:true,noiseGate:false,tubeSaturation:true,subBassEnhance:false,multiBandComp:false,deEsser:false,vocalEnhance:0,vocalExciter:0,speed:100,pitch:0},
      tone:{subBass:4,presence:-3,air:0,bassPunch:3,sparkle:0}
    },
    cinema: {
      ...
      enhance:{masterVol:110,balance:0,compThreshold:-28,compRatio:5,compAttack:5,compRelease:300,clarity:20,warmth:20000,loudnessNorm:true,monoCompat:false,analogWarmth:false,noiseGate:false,tubeSaturation:false,subBassEnhance:true,multiBandComp:true,deEsser:false,vocalEnhance:20,vocalExciter:10,speed:100,pitch:0},
      tone:{subBass:6,presence:2,air:4,bassPunch:5,sparkle:3}
    },
    night: {
      ...
      enhance:{masterVol:80,balance:0,compThreshold:-12,compRatio:12,compAttack:1,compRelease:100,clarity:0,warmth:12000,loudnessNorm:true,monoCompat:false,analogWarmth:true,noiseGate:true,tubeSaturation:false,subBassEnhance:false,multiBandComp:false,deEsser:false,vocalEnhance:0,vocalExciter:0,speed:100,pitch:0},
      tone:{subBass:2,presence:0,air:0,bassPunch:1,sparkle:0}
    },
  };
  ...
  function defaults() {
    return {
      ...
      enhance: {
        ...
        noiseGate:false, tubeSaturation:false, subBassEnhance:false,
        multiBandComp:false, deEsser:false, vocalEnhance:0, vocalExciter:0,
        speed:100, pitch:0,
      },
      tone: { subBass:0, presence:0, air:0, bassPunch:0, sparkle:0 },
    };
  ...
  function load() {
    return new Promise(r => {
      chrome.storage.local.get(['hrState','hrPresets'], d => {
        if (d.hrState) {
          S = { ...defaults(), ...d.hrState };
          S.spatial = { ...defaults().spatial, ...(d.hrState.spatial||{}) };
          S.enhance = { ...defaults().enhance, ...(d.hrState.enhance||{}) };
          S.tone = { ...defaults().tone, ...(d.hrState.tone||{}) };
        }
  ...
  function updateMaster() {
    ...
    const modeNames = {
      default: 'PURE', '16d': '16D SURROUND', '360': '360°',
      concert: 'CONCERT HALL', studio: 'STUDIO', vocal: 'VOCAL CLARITY',
      arena: 'ARENA', club: 'CLUB'
    };
    const modeName = modeNames[S.mode] || S.mode.toUpperCase();
    $('#statusText').textContent = on ? `Active · ${modeName}` : 'Engine Inactive';
  }
  ...
  const SLIDER_MAP = [
    ...
    { id:'vocalEnhance',  path:'enhance', key:'vocalEnhance',  fmt: v => v+'%' },
    { id:'vocalExciter',  path:'enhance', key:'vocalExciter',  fmt: v => v+'%' },
    ...
    { id:'bassPunch',     path:'tone',    key:'bassPunch',     fmt: v => v+' dB' },
    { id:'presence',      path:'tone',    key:'presence',      fmt: v => (v>0?'+':'')+v+' dB' },
    { id:'air',           path:'tone',    key:'air',           fmt: v => v+' dB' },
    { id:'sparkle',       path:'tone',    key:'sparkle',       fmt: v => v+' dB' },
  ];
  ...
  const SWITCH_MAP = [
    ...
    { id:'tubeSaturation',  path:'enhance', key:'tubeSaturation' },
    { id:'subBassEnhance',  path:'enhance', key:'subBassEnhance' },
    { id:'multiBandComp',   path:'enhance', key:'multiBandComp' },
    { id:'deEsser',         path:'enhance', key:'deEsser' },
  ...
  function updateSwitches() {
    SWITCH_MAP.forEach(({ id, path, key }) => {
      const el = $(`#${id}`);
      if (el && S[path][key] !== undefined) {
        el.checked = S[path][key];
      }
    });
  }
  ...
  function bindEQ() {
    ...
    $('#eqFlat').addEventListener('click', () => {
      ...
      S.tone = { subBass:0, presence:0, air:0, bassPunch:0, sparkle:0 };
